/*************************************************************
* To run this favelet on a different server, update line 202 and 213.*
**************************************************************/
                ...
                if (name.length>0) {
                    ...
                    if (file==url || file.indexOf('file')===0 ) {
                        ...
                        if (!found) {
                            ...
                            //str='<img src="http://localhost:8888/scripts/css/target.gif" alt="#'+name+'" style=\"z-index:500;">'+name;
                            str='<img src="favelets/css/target.gif" alt="#'+name+'" style=\"z-index:500;">'+name;
                        }
                        l='href=\"#'+name+'\"'; x++;
                    }
                }
